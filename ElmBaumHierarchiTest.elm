...
init () =
    ...
    , Http.get { url = "https://raw.githubusercontent.com/RicBre/Elm-Projekt-WineInformation/main/WineInformationGeoKlein.json", expect = Http.expectJson GotFlare treeDecoder }
    )
