...
var $author$project$Scatterplot$ErhalteText = function (a) {
	return {$: 'ErhalteText', a: a};
};
var $author$project$Scatterplot$Laden = {$: 'Laden'};
...
var $author$project$Scatterplot$liste = _List_fromArray(
	['WineInformationExcelAufbereitetKlein.csv']);
var $author$project$Scatterplot$holenVonCsv = function (x) {
	return $elm$core$Platform$Cmd$batch(
		A2(
			...
			$author$project$Scatterplot$liste));
};
var $author$project$Scatterplot$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Scatterplot$Laden,
		$author$project$Scatterplot$holenVonCsv($author$project$Scatterplot$ErhalteText));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Scatterplot$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Scatterplot$Erfolg = function (a) {
	return {$: 'Erfolg', a: a};
};
...
var $author$project$Scatterplot$Weine = function (name) {
	return function (alc) {
...
var $author$project$Scatterplot$dekodierenWeine = A2(
	$ericgj$elm_csv_decode$Csv$Decode$map,
	$author$project$Scatterplot$Weine,
	A2(
...
var $author$project$Scatterplot$csvStringZuDaten = function (csvRoh) {
	return A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		$elm$core$Result$toMaybe(
			A2(
				...
				$author$project$Scatterplot$dekodierenWeine,
				$lovasoa$elm_csv$Csv$parse(csvRoh))));
};
var $author$project$Scatterplot$weineListe = function (liste1) {
	return $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			function (t) {
				return $author$project$Scatterplot$csvStringZuDaten(t);
			},
			liste1));
};
var $author$project$Scatterplot$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ErhalteText':
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						$author$project$Scatterplot$Erfolg(
							{
								daten: $author$project$Scatterplot$weineListe(
									_List_fromArray(
										[fullText])),
...
var $author$project$Scatterplot$filtertReduzierteWeine = F6(
	function (weinliste, a, b, c, x, y) {
		return A3(
			$author$project$Scatterplot$XYDaten,
			x,
			y,
			A2(
				$elm$core$List$map,
				function (n) {
					return A6($author$project$Scatterplot$punktName, n, a, b, c, x, y);
				},
				weinliste));
	});
...
var $author$project$Scatterplot$abstand = 60;
...
var $author$project$Scatterplot$addieren = F2(
	function (_v0, x) {
		var min = _v0.a;
		var max = _v0.b;
		return (min <= 0) ? _Utils_Tuple2(0, max + x) : _Utils_Tuple2(min - x, max + x);
	});
var $author$project$Scatterplot$einteilungAchseZahl = 5;
...
var $author$project$Scatterplot$weiteErweiterung = function (werte) {
	var max = A2(
		$elm$core$Maybe$withDefault,
		0,
	...
	var ergebnis1 = A2($author$project$Scatterplot$addieren, ergebnis, ($author$project$Scatterplot$einteilungAchseZahl * max) / 50);
	var ergebnis2 = A2($author$project$Scatterplot$addieren, ergebnis1, 0.0);
	return ergebnis2;
};
...
var $author$project$Scatterplot$xSkala = function (werte) {
	return A2(
		$gampleman$elm_visualization$Scale$linear,
		_Utils_Tuple2(0, $author$project$Scatterplot$w - (2 * $author$project$Scatterplot$abstand)),
		$author$project$Scatterplot$weiteErweiterung(werte));
};
var $author$project$Scatterplot$xAchse = function (werte) {
	return A2(
		$gampleman$elm_visualization$Axis$bottom,
		_List_fromArray(
			[
				$gampleman$elm_visualization$Axis$tickCount($author$project$Scatterplot$einteilungAchseZahl)
			]),
		$author$project$Scatterplot$xSkala(werte));
};
...
var $author$project$Scatterplot$ySkala = function (werte) {
	return A2(
		$gampleman$elm_visualization$Scale$linear,
		_Utils_Tuple2($author$project$Scatterplot$h - (2 * $author$project$Scatterplot$abstand), 0),
		$author$project$Scatterplot$weiteErweiterung(werte));
};
var $author$project$Scatterplot$yAchse = function (werte) {
	return A2(
		...
		$author$project$Scatterplot$ySkala(werte));
};
var $author$project$Scatterplot$scatterplot = function (model) {
	var yWerte = A2(
		$elm$core$List$map,
		function ($) {
			return $.y;
		...
		model.daten);
	var ySkalaLokal = $author$project$Scatterplot$ySkala(yWerte);
	var xWerte = A2(
		$elm$core$List$map,
		function ($) {
			return $.x;
		...
		model.daten);
	var xSkalaLokal = $author$project$Scatterplot$xSkala(xWerte);
	var halb = function (t) {
		return (t.b - t.a) / 2;
	};
	var labelPosition = {
		x: halb(
			$author$project$Scatterplot$weiteErweiterung(xWerte)),
		y: $author$project$Scatterplot$weiteErweiterung(yWerte).b
	};
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Scatterplot$xAchse(xWerte),
						A2(
						$elm_community$typed_svg$TypedSvg$text_,
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$author$project$Scatterplot$yAchse(yWerte),
						A2(
						$elm_community$typed_svg$TypedSvg$text_,
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Scatterplot$abstand, $author$project$Scatterplot$abstand)
							]))
					]),
				A2(
					$elm$core$List$map,
					A2($author$project$Scatterplot$punkt, xSkalaLokal, ySkalaLokal),
					model.daten))
			]));
};
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Scatterplot$ÄndereX = function (a) {
	return {$: 'ÄndereX', a: a};
};
var $author$project$Scatterplot$ÄndereY = function (a) {
	return {$: 'ÄndereY', a: a};
};
var $author$project$Scatterplot$view = function (model) {
	switch (model.$) {
		case 'Fehlschlag':
		...
		default:
			var l = model.a;
			var weine = A6(
				$author$project$Scatterplot$filtertReduzierteWeine,
				l.daten,
				function ($) {
					return $.name;
				},
			...
			return A2(
				...
				_List_fromArray(
					[
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Scatterplot$ÄndereX(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$Scatterplot$ÄndereY(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
						...
						$author$project$Scatterplot$scatterplot(weine)
					]));
	}
};
var $author$project$Scatterplot$main = $elm$browser$Browser$element(
	{init: $author$project$Scatterplot$init, subscriptions: $author$project$Scatterplot$subscriptions, update: $author$project$Scatterplot$update, view: $author$project$Scatterplot$view});
_Platform_export({'Scatterplot':{'init':$author$project$Scatterplot$main(
