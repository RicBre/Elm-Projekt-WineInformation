...
var $author$project$Entwicklung$ElmScatterplott$ErhalteText = function (a) {
	return {$: 'ErhalteText', a: a};
};
var $author$project$Entwicklung$ElmScatterplott$Laden = {$: 'Laden'};
...
var $author$project$Entwicklung$ElmScatterplott$liste = _List_fromArray(
	['WineInformationExcelAufbereitetKlein.csv']);
var $author$project$Entwicklung$ElmScatterplott$holenVonCsv = function (x) {
	return $elm$core$Platform$Cmd$batch(
		A2(
			...
			$author$project$Entwicklung$ElmScatterplott$liste));
};
var $author$project$Entwicklung$ElmScatterplott$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Entwicklung$ElmScatterplott$Laden,
		$author$project$Entwicklung$ElmScatterplott$holenVonCsv($author$project$Entwicklung$ElmScatterplott$ErhalteText));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Entwicklung$ElmScatterplott$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Entwicklung$ElmScatterplott$Erfolg = function (a) {
	return {$: 'Erfolg', a: a};
};
...
var $author$project$Entwicklung$ElmScatterplott$Weine = function (name) {
	return function (alc) {
...
var $author$project$Entwicklung$ElmScatterplott$dekodierenWeine = A2(
	$ericgj$elm_csv_decode$Csv$Decode$map,
	$author$project$Entwicklung$ElmScatterplott$Weine,
	A2(
...
var $author$project$Entwicklung$ElmScatterplott$csvStringZuDaten = function (csvRoh) {
	return A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		$elm$core$Result$toMaybe(
			A2(
				...
				$author$project$Entwicklung$ElmScatterplott$dekodierenWeine,
				$lovasoa$elm_csv$Csv$parse(csvRoh))));
};
var $author$project$Entwicklung$ElmScatterplott$weineListe = function (liste1) {
	return $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			function (t) {
				return $author$project$Entwicklung$ElmScatterplott$csvStringZuDaten(t);
			},
			liste1));
};
var $author$project$Entwicklung$ElmScatterplott$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ErhalteText':
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmScatterplott$Erfolg(
							{
								daten: $author$project$Entwicklung$ElmScatterplott$weineListe(
									_List_fromArray(
										[fullText])),
								xAAFunktion: function ($) {
									return $.ml;
								},
								xName: 'Mililiter',
								yAAFunktion: function ($) {
									return $.preis;
								},
								yName: 'Preis'
							}),
			...
			case 'ÄndereX':
				...
				if (model.$ === 'Erfolg') {
					...
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmScatterplott$Erfolg(
							{daten: m.daten, xAAFunktion: x, xName: a, yAAFunktion: m.yAAFunktion, yName: m.yName}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (model.$ === 'Erfolg') {
					...
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmScatterplott$Erfolg(
							{daten: m.daten, xAAFunktion: m.xAAFunktion, xName: m.xName, yAAFunktion: y, yName: a}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Entwicklung$ElmScatterplott$XYDaten = F3(
	function (xBeschreibung, yBeschreibung, daten) {
		return {daten: daten, xBeschreibung: xBeschreibung, yBeschreibung: yBeschreibung};
	});
var $author$project$Entwicklung$ElmScatterplott$Punkt = F3(
	function (punktName, x, y) {
		return {punktName: punktName, x: x, y: y};
	});
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$Entwicklung$ElmScatterplott$punktName = F6(
	function (weine, u, v, x, y, z) {
		return A3(
			$author$project$Entwicklung$ElmScatterplott$Punkt,
			u(weine) + (', ' + (y + (': ' + ($elm$core$String$fromFloat(
				v(weine)) + (',' + (z + (': ' + $elm$core$String$fromFloat(
				x(weine))))))))),
			v(weine),
			x(weine));
	});
var $author$project$Entwicklung$ElmScatterplott$filtertReduzierteWeine = F6(
	function (weinliste, a, b, c, x, y) {
		return A3(
			$author$project$Entwicklung$ElmScatterplott$XYDaten,
			x,
			y,
			A2(
				$elm$core$List$map,
				function (n) {
					return A6($author$project$Entwicklung$ElmScatterplott$punktName, n, a, b, c, x, y);
				},
				weinliste));
	});
...
var $author$project$Entwicklung$ElmScatterplott$abstand = 60;
...
var $author$project$Entwicklung$ElmScatterplott$h = 450;
...
var $author$project$Entwicklung$ElmScatterplott$punkt = F3(
	function (skalaX, skalaY, yxPunkt) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$Px(12.0)),
					...
					_List_fromArray(
						[
							...
							A2($gampleman$elm_visualization$Scale$convert, skalaX, yxPunkt.x),
							A2($gampleman$elm_visualization$Scale$convert, skalaY, yxPunkt.y))
						]))
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(yxPunkt.punktName)
						]))
				]));
	});
...
var $author$project$Entwicklung$ElmScatterplott$w = 900;
var $author$project$Entwicklung$ElmScatterplott$addieren = F2(
	function (_v0, x) {
		var min = _v0.a;
		var max = _v0.b;
		return (min <= 0) ? _Utils_Tuple2(0, max + x) : _Utils_Tuple2(min - x, max + x);
	});
var $author$project$Entwicklung$ElmScatterplott$einteilungAchseZahl = 5;
...
var $author$project$Entwicklung$ElmScatterplott$weiteErweiterung = function (werte) {
	var max = A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$List$maximum(werte));
	var ergebnis = A2(
		$elm$core$Maybe$withDefault,
		_Utils_Tuple2(0, 0),
		$gampleman$elm_visualization$Statistics$extent(werte));
	var ergebnis1 = A2($author$project$Entwicklung$ElmScatterplott$addieren, ergebnis, ($author$project$Entwicklung$ElmScatterplott$einteilungAchseZahl * max) / 50);
	var ergebnis2 = A2($author$project$Entwicklung$ElmScatterplott$addieren, ergebnis1, 0.0);
	return ergebnis2;
};
...
var $author$project$Entwicklung$ElmScatterplott$xSkala = function (werte) {
	return A2(
		$gampleman$elm_visualization$Scale$linear,
		_Utils_Tuple2(0, $author$project$Entwicklung$ElmScatterplott$w - (2 * $author$project$Entwicklung$ElmScatterplott$abstand)),
		$author$project$Entwicklung$ElmScatterplott$weiteErweiterung(werte));
};
var $author$project$Entwicklung$ElmScatterplott$xAchse = function (werte) {
	return A2(
		$gampleman$elm_visualization$Axis$bottom,
		_List_fromArray(
			[
				$gampleman$elm_visualization$Axis$tickCount($author$project$Entwicklung$ElmScatterplott$einteilungAchseZahl)
			]),
		$author$project$Entwicklung$ElmScatterplott$xSkala(werte));
};
...
var $author$project$Entwicklung$ElmScatterplott$ySkala = function (werte) {
	return A2(
		$gampleman$elm_visualization$Scale$linear,
		_Utils_Tuple2($author$project$Entwicklung$ElmScatterplott$h - (2 * $author$project$Entwicklung$ElmScatterplott$abstand), 0),
		$author$project$Entwicklung$ElmScatterplott$weiteErweiterung(werte));
};
var $author$project$Entwicklung$ElmScatterplott$yAchse = function (werte) {
	return A2(
		...
		$author$project$Entwicklung$ElmScatterplott$ySkala(werte));
};
var $author$project$Entwicklung$ElmScatterplott$scatterplot = function (model) {
	var yWerte = A2(
		$elm$core$List$map,
		function ($) {
			return $.y;
		...
		model.daten);
	var ySkalaLokal = $author$project$Entwicklung$ElmScatterplott$ySkala(yWerte);
	var xWerte = A2(
		$elm$core$List$map,
		function ($) {
			return $.x;
		...
		model.daten);
	var xSkalaLokal = $author$project$Entwicklung$ElmScatterplott$xSkala(xWerte);
	var halb = function (t) {
		return (t.b - t.a) / 2;
	};
	var labelPosition = {
		x: halb(
			$author$project$Entwicklung$ElmScatterplott$weiteErweiterung(xWerte)),
		y: $author$project$Entwicklung$ElmScatterplott$weiteErweiterung(yWerte).b
	};
	return A2(
		$elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Entwicklung$ElmScatterplott$w, $author$project$Entwicklung$ElmScatterplott$h),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, 60, 390)
							]))
					]),
				_List_fromArray(
					[
						$author$project$Entwicklung$ElmScatterplott$xAchse(xWerte),
						A2(
						$elm_community$typed_svg$TypedSvg$text_,
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$x(
								A2($gampleman$elm_visualization$Scale$convert, xSkalaLokal, labelPosition.x)),
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$y(35),
								$elm_community$typed_svg$TypedSvg$Attributes$fontFamily(
								_List_fromArray(
									['calibri'])),
								$elm_community$typed_svg$TypedSvg$Attributes$fontSize(
						...
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Core$text(model.xBeschreibung)
							]))
					])),
				A2(
				$elm_community$typed_svg$TypedSvg$g,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, 60, 60)
							]))
					]),
				_List_fromArray(
					[
						$author$project$Entwicklung$ElmScatterplott$yAchse(yWerte),
						A2(
						$elm_community$typed_svg$TypedSvg$text_,
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$x(-30),
						...
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Core$text(model.yBeschreibung)
							]))
					])),
				A2(
				$elm_community$typed_svg$TypedSvg$g,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Entwicklung$ElmScatterplott$abstand, $author$project$Entwicklung$ElmScatterplott$abstand)
							]))
					]),
				A2(
					$elm$core$List$map,
					A2($author$project$Entwicklung$ElmScatterplott$punkt, xSkalaLokal, ySkalaLokal),
					model.daten))
			]));
};
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Entwicklung$ElmScatterplott$ÄndereX = function (a) {
	return {$: 'ÄndereX', a: a};
};
var $author$project$Entwicklung$ElmScatterplott$ÄndereY = function (a) {
	return {$: 'ÄndereY', a: a};
};
var $author$project$Entwicklung$ElmScatterplott$view = function (model) {
	switch (model.$) {
		case 'Fehlschlag':
		...
		default:
			var l = model.a;
			var weine = A6(
				$author$project$Entwicklung$ElmScatterplott$filtertReduzierteWeine,
				l.daten,
				function ($) {
					return $.name;
				},
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Suchen eine Eigenschaft für die X-Achse aus'),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$Entwicklung$ElmScatterplott$ÄndereX(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Suchen eine Eigenschaft für die Y-Achse aus'),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$Entwicklung$ElmScatterplott$ÄndereY(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
						...
						$author$project$Entwicklung$ElmScatterplott$scatterplot(weine)
					]));
	}
};
var $author$project$Entwicklung$ElmScatterplott$main = $elm$browser$Browser$element(
	{init: $author$project$Entwicklung$ElmScatterplott$init, subscriptions: $author$project$Entwicklung$ElmScatterplott$subscriptions, update: $author$project$Entwicklung$ElmScatterplott$update, view: $author$project$Entwicklung$ElmScatterplott$view});
_Platform_export({'Entwicklung':{'ElmScatterplott':{'init':$author$project$Entwicklung$ElmScatterplott$main(
