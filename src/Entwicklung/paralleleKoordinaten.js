...
var $author$project$Entwicklung$ElmParalleleKoordinaten$ErhalteText = function (a) {
	return {$: 'ErhalteText', a: a};
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$Laden = {$: 'Laden'};
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$liste = _List_fromArray(
	['WineInformationExcelAufbereitetKlein.csv']);
var $author$project$Entwicklung$ElmParalleleKoordinaten$holenVonCsv = function (x) {
	return $elm$core$Platform$Cmd$batch(
		A2(
			...
			$author$project$Entwicklung$ElmParalleleKoordinaten$liste));
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Entwicklung$ElmParalleleKoordinaten$Laden,
		$author$project$Entwicklung$ElmParalleleKoordinaten$holenVonCsv($author$project$Entwicklung$ElmParalleleKoordinaten$ErhalteText));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Entwicklung$ElmParalleleKoordinaten$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$Erfolg = function (a) {
	return {$: 'Erfolg', a: a};
};
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$Weine = function (name) {
	return function (alc) {
		return function (temperatur) {
			return function (suesse) {
				return function (saeurengehalt) {
					return function (koerper) {
						return function (gerbstoff) {
							return function (preis) {
								return function (jahr) {
									return function (ml) {
										return {alc: alc, gerbstoff: gerbstoff, jahr: jahr, koerper: koerper, ml: ml, name: name, preis: preis, saeurengehalt: saeurengehalt, suesse: suesse, temperatur: temperatur};
									};
								};
							};
						};
...
var $ericgj$elm_csv_decode$Csv$Decode$andMap = F2(
	function (_v0, _v1) {
		var decodeAfter = _v0.a;
		var decodeBefore = _v1.a;
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$dekodierenWeine = A2(
	$ericgj$elm_csv_decode$Csv$Decode$map,
	$author$project$Entwicklung$ElmParalleleKoordinaten$Weine,
	A2(
		...
		A2(
			...
			A2(
				...
				$elm$core$Result$fromMaybe('error parsing string'))),
		A2(
			$ericgj$elm_csv_decode$Csv$Decode$andMap,
			A2(
				$ericgj$elm_csv_decode$Csv$Decode$field,
									...
									A2(
										...
										A2(
											...
											A2(
												...
												$elm$core$String$toFloat,
												$elm$core$Result$fromMaybe('error parsing string'))),
										A2($ericgj$elm_csv_decode$Csv$Decode$field, 'name', $elm$core$Result$Ok)))))))))));
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$csvStringZuDaten = function (csvRoh) {
	return A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		$elm$core$Result$toMaybe(
			A2(
				...
				$author$project$Entwicklung$ElmParalleleKoordinaten$dekodierenWeine,
				$lovasoa$elm_csv$Csv$parse(csvRoh))));
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$weineListe = function (liste1) {
	return $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			function (t) {
				return $author$project$Entwicklung$ElmParalleleKoordinaten$csvStringZuDaten(t);
			},
			liste1));
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ErhalteText':
				var ergebnis = msg.a;
				if (ergebnis.$ === 'Ok') {
					var fullText = ergebnis.a;
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmParalleleKoordinaten$Erfolg(
							{
								data: $author$project$Entwicklung$ElmParalleleKoordinaten$weineListe(
									_List_fromArray(
										[fullText])),
								dritteFunktion: function ($) {
									return $.suesse;
								},
								dritterName: 'Süße',
								ersteFunktion: function ($) {
									return $.alc;
								},
								ersterName: 'Alkohol',
								vierteFunktion: function ($) {
									return $.saeurengehalt;
								},
								vierterName: 'Säuregehalt',
								zweiteFunktion: function ($) {
									return $.temperatur;
								},
								zweiterName: 'Temperatur'
							}),
			...
			case 'Ändere1':
				...
				if (model.$ === 'Erfolg') {
					...
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmParalleleKoordinaten$Erfolg(
							{data: m.data, dritteFunktion: m.dritteFunktion, dritterName: m.dritterName, ersteFunktion: x, ersterName: a, vierteFunktion: m.vierteFunktion, vierterName: m.vierterName, zweiteFunktion: m.zweiteFunktion, zweiterName: m.zweiterName}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'Ändere2':
				...
				if (model.$ === 'Erfolg') {
					...
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmParalleleKoordinaten$Erfolg(
							{data: m.data, dritteFunktion: m.dritteFunktion, dritterName: m.dritterName, ersteFunktion: m.ersteFunktion, ersterName: m.ersterName, vierteFunktion: m.vierteFunktion, vierterName: m.vierterName, zweiteFunktion: y, zweiterName: a}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'Ändere3':
				...
				if (model.$ === 'Erfolg') {
					...
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmParalleleKoordinaten$Erfolg(
							{data: m.data, dritteFunktion: z, dritterName: a, ersteFunktion: m.ersteFunktion, ersterName: m.ersterName, vierteFunktion: m.vierteFunktion, vierterName: m.vierterName, zweiteFunktion: m.zweiteFunktion, zweiterName: m.zweiterName}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (model.$ === 'Erfolg') {
					...
					return _Utils_Tuple2(
						$author$project$Entwicklung$ElmParalleleKoordinaten$Erfolg(
							{data: m.data, dritteFunktion: m.dritteFunktion, dritterName: m.dritterName, ersteFunktion: m.ersteFunktion, ersterName: m.ersterName, vierteFunktion: c, vierterName: a, zweiteFunktion: m.zweiteFunktion, zweiterName: m.zweiterName}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$MultiDimData = F2(
	function (dimDescription, data) {
		return {data: data, dimDescription: dimDescription};
	});
var $author$project$Entwicklung$ElmParalleleKoordinaten$MultiDimPunkt = F2(
	function (punktName, value) {
		return {punktName: punktName, value: value};
	});
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$abstand = 60;
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$einteilungAchseZahl = 8;
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$standartErweiterung = _Utils_Tuple2(0, 100);
var $author$project$Entwicklung$ElmParalleleKoordinaten$weiteErweiterung = function (werte) {
	var nahErweiterung = A2(
		$elm$core$Maybe$withDefault,
		$author$project$Entwicklung$ElmParalleleKoordinaten$standartErweiterung,
		$gampleman$elm_visualization$Statistics$extent(werte));
	var erwiterung = (nahErweiterung.b - nahErweiterung.a) / (2 * $author$project$Entwicklung$ElmParalleleKoordinaten$einteilungAchseZahl);
	return _Utils_Tuple2(
		A2($elm$core$Basics$max, 0, nahErweiterung.a - erwiterung),
		nahErweiterung.b + erwiterung);
};
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$paralleleKoordinatenPlan = F3(
	function (w, ar, model) {
		var xSkala = A2(
			...
			_Utils_Tuple2(
				1,
				$elm$core$List$length(model.dimDescription)));
		var listeTransformieren = $elm_community$list_extra$List$Extra$transpose(
			A2(
				$elm$core$List$map,
				function ($) {
					return $.value;
				},
				$elm$core$List$concat(model.data)));
		var listeWeiteErweiterung = A2($elm$core$List$map, $author$project$Entwicklung$ElmParalleleKoordinaten$weiteErweiterung, listeTransformieren);
		var h = w / ar;
		var listeSkala = A2(
			$elm$core$List$map,
			$gampleman$elm_visualization$Scale$linear(
		...
		var listeAchse = A2(
			...
			$gampleman$elm_visualization$Axis$left(
				_List_fromArray(
					[
						$gampleman$elm_visualization$Axis$tickCount($author$project$Entwicklung$ElmParalleleKoordinaten$einteilungAchseZahl)
					])),
			listeSkala);
		return A2(
			...
			_List_fromArray(
				[
					A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, w + (2 * $author$project$Entwicklung$ElmParalleleKoordinaten$abstand), h + (2 * $author$project$Entwicklung$ElmParalleleKoordinaten$abstand)),
					$elm_community$typed_svg$TypedSvg$Attributes$width(
					$elm_community$typed_svg$TypedSvg$Types$Percent(90)),
			...
			_Utils_ap(
				_List_fromArray(
					[
						A2($elm_community$typed_svg$TypedSvg$style, _List_Nil, _List_Nil),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Entwicklung$ElmParalleleKoordinaten$abstand - 1, $author$project$Entwicklung$ElmParalleleKoordinaten$abstand)
											]))
									]),
								A2(
													...
													[
														...
														_List_fromArray(
															[
																...
																A2($gampleman$elm_visualization$Scale$convert, xSkala, i + 1),
																0)
															]))
													]),
												_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Entwicklung$ElmParalleleKoordinaten$abstand - 1, 0)
											]))
									]),
								A2(
									$elm$core$List$indexedMap,
											...
											return A2(
												...
												_List_fromArray(
													[
														...
														A2($gampleman$elm_visualization$Scale$convert, xSkala, i + 1)),
														$elm_community$typed_svg$TypedSvg$Attributes$InPx$y(($author$project$Entwicklung$ElmParalleleKoordinaten$abstand * 7) / 8),
														$elm_community$typed_svg$TypedSvg$Attributes$textAnchor($elm_community$typed_svg$TypedSvg$Types$AnchorMiddle)
													]),
												_List_fromArray(
													[
														$elm_community$typed_svg$TypedSvg$Core$text(desc)
													]));
										}),
							...
							A4(
								...
								F3(
									function (desc, s, px) {
										return $elm$core$Maybe$Just(
											_Utils_Tuple2(
												A2($gampleman$elm_visualization$Scale$convert, xSkala, desc),
												A2($gampleman$elm_visualization$Scale$convert, s, px)));
									}),
								A2(
									$elm$core$List$range,
									1,
							...
							_List_fromArray(
								[
									...
									$elm_community$typed_svg$TypedSvg$Types$Paint(
										A4($avh4$elm_color$Color$rgba, 0, 0, 0, 0.8))),
...
var $author$project$Entwicklung$ElmParalleleKoordinaten$Ändere1 = function (a) {
	return {$: 'Ändere1', a: a};
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$Ändere2 = function (a) {
	return {$: 'Ändere2', a: a};
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$Ändere3 = function (a) {
	return {$: 'Ändere3', a: a};
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$Ändere4 = function (a) {
	return {$: 'Ändere4', a: a};
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$view = function (model) {
	switch (model.$) {
		case 'Fehlschlag':
			return $elm$html$Html$text('Ich konnte Ihre Weine nicht öffnen.');
		case 'Laden':
			return $elm$html$Html$text('Weine werden geöffnet...');
		default:
			var l = model.a;
			var multiDimDaten = function (listeWeine) {
				return function (a) {
					return function (b) {
						return function (c) {
							return function (d) {
									...
									return function (f) {
										return function (g) {
											return function (h) {
												return function (i) {
													return A2(
														$author$project$Entwicklung$ElmParalleleKoordinaten$MultiDimData,
														_List_fromArray(
															[f, g, h, i]),
														_List_fromArray(
															[
																...
																function (x) {
																	return A2(
																		$author$project$Entwicklung$ElmParalleleKoordinaten$MultiDimPunkt,
																		e(x),
																		_List_fromArray(
																			[
																				a(x),
			...
			var plotDaten = multiDimDaten(l.data)(l.ersteFunktion)(l.zweiteFunktion)(l.dritteFunktion)(l.vierteFunktion)(
				function ($) {
					return $.name;
				})(l.ersterName)(l.zweiterName)(l.dritterName)(l.vierterName);
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Suchen eine Eigenschaft für die erste Spalte aus'),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$Entwicklung$ElmParalleleKoordinaten$Ändere1(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Alkoholgehalt')
											])),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												...
												$author$project$Entwicklung$ElmParalleleKoordinaten$Ändere1(
													_Utils_Tuple2(
														...
														'Durchschnittliche Trinktemperatur')))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Trinktemperatur')
											])),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Säuregehalt')
											])),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Suchen eine Eigenschaft für die zweite Spalte aus'),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$Entwicklung$ElmParalleleKoordinaten$Ändere2(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Suchen eine Eigenschaft für die dritte Spalte aus'),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$Entwicklung$ElmParalleleKoordinaten$Ändere3(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Suchen eine Eigenschaft für die vierte Spalte aus'),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$Entwicklung$ElmParalleleKoordinaten$Ändere4(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
						...
						A3($author$project$Entwicklung$ElmParalleleKoordinaten$paralleleKoordinatenPlan, 600, 2, plotDaten)
					]));
	}
};
var $author$project$Entwicklung$ElmParalleleKoordinaten$main = $elm$browser$Browser$element(
	{init: $author$project$Entwicklung$ElmParalleleKoordinaten$init, subscriptions: $author$project$Entwicklung$ElmParalleleKoordinaten$subscriptions, update: $author$project$Entwicklung$ElmParalleleKoordinaten$update, view: $author$project$Entwicklung$ElmParalleleKoordinaten$view});
_Platform_export({'Entwicklung':{'ElmParalleleKoordinaten':{'init':$author$project$Entwicklung$ElmParalleleKoordinaten$main(
