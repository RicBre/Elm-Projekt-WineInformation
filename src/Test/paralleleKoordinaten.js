...
var $author$project$ParalleleKoordinaten$ErhalteText = function (a) {
	return {$: 'ErhalteText', a: a};
};
var $author$project$ParalleleKoordinaten$Laden = {$: 'Laden'};
...
var $author$project$ParalleleKoordinaten$liste = _List_fromArray(
	['WineInformationExcelAufbereitetKlein.csv']);
var $author$project$ParalleleKoordinaten$holenVonCsv = function (x) {
	return $elm$core$Platform$Cmd$batch(
		A2(
			...
			$author$project$ParalleleKoordinaten$liste));
};
var $author$project$ParalleleKoordinaten$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$ParalleleKoordinaten$Laden,
		$author$project$ParalleleKoordinaten$holenVonCsv($author$project$ParalleleKoordinaten$ErhalteText));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$ParalleleKoordinaten$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ParalleleKoordinaten$Erfolg = function (a) {
	return {$: 'Erfolg', a: a};
};
...
var $author$project$ParalleleKoordinaten$Weine = function (name) {
	return function (alc) {
...
var $author$project$ParalleleKoordinaten$dekodierenWeine = A2(
	$ericgj$elm_csv_decode$Csv$Decode$map,
	$author$project$ParalleleKoordinaten$Weine,
	A2(
...
var $author$project$ParalleleKoordinaten$csvStringZuDaten = function (csvRoh) {
	return A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		$elm$core$Result$toMaybe(
			A2(
				...
				$author$project$ParalleleKoordinaten$dekodierenWeine,
				$lovasoa$elm_csv$Csv$parse(csvRoh))));
};
var $author$project$ParalleleKoordinaten$weineListe = function (liste1) {
	return $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			function (t) {
				return $author$project$ParalleleKoordinaten$csvStringZuDaten(t);
			},
			liste1));
};
var $author$project$ParalleleKoordinaten$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ErhalteText':
				var ergebnis = msg.a;
				if (ergebnis.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						$author$project$ParalleleKoordinaten$Erfolg(
							{
								data: $author$project$ParalleleKoordinaten$weineListe(
									_List_fromArray(
										[fullText])),
...
var $author$project$ParalleleKoordinaten$MultiDimData = F2(
	function (dimDescription, data) {
		return {data: data, dimDescription: dimDescription};
	});
var $author$project$ParalleleKoordinaten$MultiDimPunkt = F2(
...
var $author$project$ParalleleKoordinaten$abstand = 60;
...
var $author$project$ParalleleKoordinaten$einteilungAchseZahl = 8;
...
var $author$project$ParalleleKoordinaten$standartErweiterung = _Utils_Tuple2(0, 100);
var $author$project$ParalleleKoordinaten$weiteErweiterung = function (werte) {
	var nahErweiterung = A2(
		$elm$core$Maybe$withDefault,
		$author$project$ParalleleKoordinaten$standartErweiterung,
		$gampleman$elm_visualization$Statistics$extent(werte));
	var erwiterung = (nahErweiterung.b - nahErweiterung.a) / (2 * $author$project$ParalleleKoordinaten$einteilungAchseZahl);
	return _Utils_Tuple2(
...
var $author$project$ParalleleKoordinaten$paralleleKoordinatenPlan = F3(
	function (w, ar, model) {
		var xSkala = A2(
		...
		var listeWeiteErweiterung = A2($elm$core$List$map, $author$project$ParalleleKoordinaten$weiteErweiterung, listeTransformieren);
		var h = w / ar;
		var listeSkala = A2(
			$elm$core$List$map,
			$gampleman$elm_visualization$Scale$linear(
		...
		var listeAchse = A2(
			...
			$gampleman$elm_visualization$Axis$left(
				_List_fromArray(
					[
						$gampleman$elm_visualization$Axis$tickCount($author$project$ParalleleKoordinaten$einteilungAchseZahl)
					])),
			listeSkala);
		return A2(
			...
			_List_fromArray(
				[
					A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, w + (2 * $author$project$ParalleleKoordinaten$abstand), h + (2 * $author$project$ParalleleKoordinaten$abstand)),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$ParalleleKoordinaten$abstand - 1, $author$project$ParalleleKoordinaten$abstand)
											]))
									]),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$ParalleleKoordinaten$abstand - 1, 0)
											]))
									]),
								A2(
									$elm$core$List$indexedMap,
											...
											return A2(
												...
												_List_fromArray(
													[
														...
														A2($gampleman$elm_visualization$Scale$convert, xSkala, i + 1)),
														$elm_community$typed_svg$TypedSvg$Attributes$InPx$y(($author$project$ParalleleKoordinaten$abstand * 7) / 8),
...
var $author$project$ParalleleKoordinaten$Ändere1 = function (a) {
	return {$: 'Ändere1', a: a};
};
var $author$project$ParalleleKoordinaten$Ändere2 = function (a) {
	return {$: 'Ändere2', a: a};
};
var $author$project$ParalleleKoordinaten$Ändere3 = function (a) {
	return {$: 'Ändere3', a: a};
};
var $author$project$ParalleleKoordinaten$Ändere4 = function (a) {
	return {$: 'Ändere4', a: a};
};
var $author$project$ParalleleKoordinaten$view = function (model) {
	switch (model.$) {
		case 'Fehlschlag':
									...
									return function (f) {
										return function (g) {
											return function (h) {
												return function (i) {
													return A2(
														$author$project$ParalleleKoordinaten$MultiDimData,
														_List_fromArray(
															[f, g, h, i]),
														_List_fromArray(
															[
																...
																function (x) {
																	return A2(
																		$author$project$ParalleleKoordinaten$MultiDimPunkt,
																		e(x),
																		_List_fromArray(
																			[
																				a(x),
			...
			return A2(
				...
				_List_fromArray(
					[
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$ParalleleKoordinaten$Ändere1(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$ParalleleKoordinaten$Ändere2(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$ParalleleKoordinaten$Ändere3(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick(
												$author$project$ParalleleKoordinaten$Ändere4(
													_Utils_Tuple2(
														function ($) {
															return $.alc;
														},
						...
						A3($author$project$ParalleleKoordinaten$paralleleKoordinatenPlan, 600, 2, plotDaten)
					]));
	}
};
var $author$project$ParalleleKoordinaten$main = $elm$browser$Browser$element(
	{init: $author$project$ParalleleKoordinaten$init, subscriptions: $author$project$ParalleleKoordinaten$subscriptions, update: $author$project$ParalleleKoordinaten$update, view: $author$project$ParalleleKoordinaten$view});
_Platform_export({'ParalleleKoordinaten':{'init':$author$project$ParalleleKoordinaten$main(
